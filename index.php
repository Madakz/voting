  ...
  <header id="home">
    <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
      <div class="carousel-inner">
        <div class="item active" style="background-image: url(images/slider/rfc2.jpg)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig">Welcome to <span>Rofosa Jos 2017 Elections</span></h1>
            <!-- <p class="animated fadeInRightBig">Bootstrap - Responsive Design - Retina Ready - Parallax</p> -->
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Vote now</a>
          </div>
        </div>
        <div class="item" style="background-image: url(images/slider/rfc1.jpg)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig">Vote for <span>Progress</span></h1>
            <p class="animated fadeInRightBig">It is your right!</p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Vote now</a>
          </div>
        </div>
        <div class="item" style="background-image: url(images/slider/rfc3.jpg)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig">Lets make <span>History</span></h1>
            <p class="animated fadeInRightBig">Together as one Holy family</p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Vote now</a>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        ...
        <?php
          ...
          <p style="color:red; text-align: center; font-size: 20px;"><?php echo $login->login($phone_number, $password);  }?></p>
